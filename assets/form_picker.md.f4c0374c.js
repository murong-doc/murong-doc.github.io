import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.ed8fde47.js";const g=JSON.parse('{"title":"Picker 选择器组件","description":"","frontmatter":{},"headers":[],"relativePath":"form/picker.md","filePath":"form/picker.md"}'),p={name:"form/picker.md"},t=l(`<h1 id="picker-选择器组件" tabindex="-1">Picker 选择器组件 <a class="header-anchor" href="#picker-选择器组件" aria-label="Permalink to &quot;Picker 选择器组件&quot;">​</a></h1><ul><li>选择器组件提供了 一种弹窗模式选择</li><li>此选择器有两种弹出模式</li><li><ul><li>一是时间模式，可以配置年，日，月，时，分，秒参数</li></ul></li><li><ul><li>二是地区模式，可以配置省，市，区参数</li></ul></li></ul><h2 id="基本使用" tabindex="-1">基本使用 <a class="header-anchor" href="#基本使用" aria-label="Permalink to &quot;基本使用&quot;">​</a></h2><ul><li>通过<code>mode</code>参数设置为<code>time</code>、<code>region</code>，区分时间、地区模式。</li><li>通过<code>v-model</code>双向绑定一个值为布尔值的变量，来打开或者收起picker。</li></ul><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span>
