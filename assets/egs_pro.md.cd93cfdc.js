import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.ed8fde47.js";const d=JSON.parse('{"title":"项目示例 TODO","description":"","frontmatter":{},"headers":[],"relativePath":"egs/pro.md","filePath":"egs/pro.md"}'),p={name:"egs/pro.md"},o=l(`<h1 id="项目示例-todo" tabindex="-1">项目示例 TODO <a class="header-anchor" href="#项目示例-todo" aria-label="Permalink to &quot;项目示例 TODO&quot;">​</a></h1><p>tags 业务组件 基于 mrTag 实现多个标签 的展示和选择, 同时支持单选、多选业务 支持v-model(重要)</p><h2 id="基本使用" tabindex="-1">基本使用 <a class="header-anchor" href="#基本使用" aria-label="Permalink to &quot;基本使用&quot;">​</a></h2><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span>
