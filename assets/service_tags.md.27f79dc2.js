import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.ed8fde47.js";const d=JSON.parse('{"title":"tags 业务组件","description":"","frontmatter":{},"headers":[],"relativePath":"service/tags.md","filePath":"service/tags.md"}'),p={name:"service/tags.md"},o=l(`<h1 id="tags-业务组件" tabindex="-1">tags 业务组件 <a class="header-anchor" href="#tags-业务组件" aria-label="Permalink to &quot;tags 业务组件&quot;">​</a></h1><p>tags 业务组件 基于 mrTag 实现多个标签 的展示和选择, 同时支持单选、多选业务、v-model（双向绑定）</p><h2 id="基本使用" tabindex="-1">基本使用 <a class="header-anchor" href="#基本使用" aria-label="Permalink to &quot;基本使用&quot;">​</a></h2><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span>
