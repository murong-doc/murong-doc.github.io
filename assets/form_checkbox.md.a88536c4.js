import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.ed8fde47.js";const x=JSON.parse('{"title":"Checkbox 多选框组件","description":"","frontmatter":{},"headers":[],"relativePath":"form/checkbox.md","filePath":"form/checkbox.md"}'),p={name:"form/checkbox.md"},o=l(`<h1 id="checkbox-多选框组件" tabindex="-1">Checkbox 多选框组件 <a class="header-anchor" href="#checkbox-多选框组件" aria-label="Permalink to &quot;Checkbox 多选框组件&quot;">​</a></h1><p>复选框组件一般用于需要多个选择的场景，该组件功能完整，使用方便</p><h2 id="基本使用" tabindex="-1">基本使用 <a class="header-anchor" href="#基本使用" aria-label="Permalink to &quot;基本使用&quot;">​</a></h2><ul><li>需要设置<code>name</code>值、通过<code>v-model</code>绑定</li></ul><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span>
