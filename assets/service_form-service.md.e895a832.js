import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.ed8fde47.js";const m=JSON.parse('{"title":"form 业务组件","description":"","frontmatter":{},"headers":[],"relativePath":"service/form-service.md","filePath":"service/form-service.md"}'),p={name:"service/form-service.md"},o=l(`<h1 id="form-业务组件" tabindex="-1">form 业务组件 <a class="header-anchor" href="#form-业务组件" aria-label="Permalink to &quot;form 业务组件&quot;">​</a></h1><p>form 业务组件 基于基本配置，快速生成基础表单，并拥有基础表单的功能（数据录入、校验、输入类型选择）</p><h2 id="基本使用" tabindex="-1">基本使用 <a class="header-anchor" href="#基本使用" aria-label="Permalink to &quot;基本使用&quot;">​</a></h2><p>表单组件 通过提供 结构配置项 <code>form-conf</code> 和 表单数据接收对象<code>form</code> 就可以生成基础表单</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span>
