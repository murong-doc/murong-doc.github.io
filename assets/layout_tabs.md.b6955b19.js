import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.ed8fde47.js";const g=JSON.parse('{"title":"Tabs 标签","description":"","frontmatter":{},"headers":[],"relativePath":"layout/tabs.md","filePath":"layout/tabs.md"}'),p={name:"layout/tabs.md"},t=l(`<h1 id="tabs-标签" tabindex="-1">Tabs 标签 <a class="header-anchor" href="#tabs-标签" aria-label="Permalink to &quot;Tabs 标签&quot;">​</a></h1><p>该组件，是一个tabs标签组件，在标签多的时候，可以配置为左右滑动，标签少的时候，可以禁止滑动。 该组件的一个特点是配置为滚动模式时，激活的tab会自动移动到组件的中间位置。</p><h2 id="基本使用" tabindex="-1">基本使用 <a class="header-anchor" href="#基本使用" aria-label="Permalink to &quot;基本使用&quot;">​</a></h2><ul><li>通过设置<code>is-scroll</code>(默认为<code>true</code>)，配置tabs组件的内容是否可以左右拖动，一般4个标签以下时，无需拖动，设置为false，5个标签以上，建议可以左右拖动。 tabs标签的切换，需要绑定<code>current</code>值，在<code>change</code>事件回调中可以得到<code>index</code>，将其赋值给<code>current</code>即可。</li></ul><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span>
