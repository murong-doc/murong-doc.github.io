import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.ed8fde47.js";const u=JSON.parse('{"title":"Form 表单","description":"","frontmatter":{},"headers":[],"relativePath":"form/form.md","filePath":"form/form.md"}'),p={name:"form/form.md"},o=l(`<h1 id="form-表单" tabindex="-1">Form 表单 <a class="header-anchor" href="#form-表单" aria-label="Permalink to &quot;Form 表单&quot;">​</a></h1><p>此组件一般用于表单场景,可以配置Input输入框,Select弹出框,进行表单验证等。</p><h2 id="基本使用" tabindex="-1">基本使用 <a class="header-anchor" href="#基本使用" aria-label="Permalink to &quot;基本使用&quot;">​</a></h2><ul><li><p>此组件一般是用于表单验证使用,每一个表单域由一个mr-form-item组成,表单域中可以放置mr-input、mr-checkbox、mr-radio、mr-switch等。</p></li><li><p>在表单组中,通过model参数绑定一个对象,这个对象的属性为各个mr-form-item内组件的对应变量。</p></li><li><p>由于表单验证和绑定表单规则时,需要通过ref操作,故这里需要给form组件声明ref=&quot;mrForm&quot;属性。</p></li><li><p>关于mr-from-item内其他可能包含的诸如input、radio等组件,请见各自组件的相关文档说明。</p></li></ul><p>下方为一个表单的示例,包含input、textarea、radio、checkbox、switch等等的组合使用：</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span>
